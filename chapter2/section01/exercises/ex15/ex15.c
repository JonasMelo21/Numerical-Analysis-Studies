/*
    Created by Jonas H. Melo on 2024/08/11
    ...
    Approach: Let's find a solution for x^3 - x - 1 = 0 with 10^(-4) digits of precision.
*/
...
int main() {
    double interval[2] = {1, 2};  // Correct initialization of the interval
    double tol = pow(10, -3);
